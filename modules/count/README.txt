...
The Count Nodes Module counts total number of nodes created(published and unpublished both) in each content type. It provide a total number of blocks equals to the total number of content types created such that administrator can use one block each for each content type. 
...
For a full description of the module, visit the project page:
  http://drupal.org/project/count_nodes

To submit bug reports and feature suggestions, or to track changes:
  http://drupal.org/project/issues/count_nodes
