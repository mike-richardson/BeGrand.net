  ...
  <div id="page" class="container-16 clear-block">
    ...
    <div id="main" class="column <?php print ns('grid-16', $left, 4, $right, 4) . ' ' . ns('push-4', !$left, 4); ?>">
      ...
      <?php 
      	...
      	$saferef="http://www.surveymonkey.com/s_thankyou.aspx";
      	
      	global $user;
      	if ($thisref=="https://begrand.net/node/6051/webform-results") {
      		print $content;
      	} else {
	      	if (strstr($thisref, $saferef)) {
				print $content;       	
			} else {
				echo "<h1>Please complete our survey</h1>";
				echo "<p>Please take part in our latest survey by clicking <a href=\"http://www.surveymonkey.com/s/dfesurvey\">here</a>. Once you have completed the survey you will be taken back to this page</p>";
				echo "<p>As a thank you for taking part, we would like to enter you into our prize draw, with the chance of winning &pound;100 in Marks &amp; Spencers gift vouchers. There will be one lucky winner, who will be selected at random from all the responses we receive.</p>";
	      	}
	      }
      ?>
