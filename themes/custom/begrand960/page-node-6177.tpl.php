...
<body class="<?php print $body_classes; ?> <?php print themer_body_class(); ?>">
  <div id="page" class="container-16 clear-block">
    ...
    <div id="main" class="column <?php print ns('grid-16', $left, 4, $right, 4) . ' ' . ns('push-4', !$left, 4); ?>">
      ...
      <?php print $events_find ?>
      </div>
      <?php endif; ?>
      
      <?php if ($events_map): ?>
    <div id="events_map">
    	<?php print $events_map ?>
    </div>
    <?php endif; ?>
      ...
      <?php if ($featured_events): ?>
      	<div id="featured_events">
			<?php print $featured_events ?>
		</div>
      <?php endif; ?>
      
	
    
     <?php if ($event_comments): ?>
    <div id="event_comments">
    	<?php print $event_comments ?>
    </div>
    <?php endif; ?>
    
    <?php if ($past_events): ?>
     <div id="past_events">
    	<?php print $past_events ?>
    </div>
    <?php endif; ?>
